...
import com.kylexu.chapter7.entity.User;
import com.kylexu.chapter7.mapper.UserMapper;
...
public class Chapter7ApplicationTests {
    ...
    private Logger log = LoggerFactory.getLogger(Chapter7ApplicationTests.class);
